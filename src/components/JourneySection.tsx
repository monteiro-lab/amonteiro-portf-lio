...
function MilestoneCard({ milestone, i }: { milestone: any; i: number }) {
  ...
  // fica ativo quando o topo do elemento cruza o meio da tela
...
export default function JourneySection() {
  ...
  // acompanha o progresso do scroll dentro dessa seção
  const { scrollYProgress } = useScroll({
    target: containerRef,
    offset: ["start center", "end center"]
  });

  // suaviza o valor do scroll pra animação não ficar travada
    ...
    <section id="journey" className="relative py-32 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div ref={containerRef} className="relative">
          ...
          {/* linha colorida que preenche conforme o scroll */}
          <motion.div 
